...
export const Timeline = ({
  ...
  return (
    <div
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto mt-4">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start py-10">
            <div
              ...
              <h3
                className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-neutral-200 ">
                {item.title}
              </h3>
            </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3
                className="md:hidden block text-2xl mb-4 text-left font-bold text-neutral-200">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
